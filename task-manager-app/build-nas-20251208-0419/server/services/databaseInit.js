...
function createTablesIfNotExist(prisma) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            try {
                (0, child_process_1.execSync)('npm run prisma:generate', { stdio: 'inherit', cwd: '/app' });
            }
            catch (e) {
            ...
            yield prisma.$executeRawUnsafe(`PRAGMA foreign_keys = OFF`);
...
function initializeDatabaseIfEmpty(prisma) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield prisma.$executeRawUnsafe(`PRAGMA foreign_keys = ON`);
            return {
